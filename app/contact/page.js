  ...
  return (
    <div>
      <section className="text-gray-400 bg-gray-800 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap sm:h-full md:h-full">
          <motion.div
          ...
          >
            ...
            <motion.div
              ...
              whileHover={{ scale: 1, originX: 0, color: "#f8e112" }}
              transition={{
                delay: 1.2,
                duration: 0.8,
              }}
          ...
          >
            ...
            <p className="leading-relaxed mb-5">
              Share your insights for enhancement.
            </p>
            ...
            <motion.button
              ...
              initial={{ x: "100vh", scale: 0.8, opacity: 0.8 }}
              animate={{ x: 0 }}
              whileHover={{
                scale: 1,
                originX: 0,
